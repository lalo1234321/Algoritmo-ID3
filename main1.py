...
#df = pd.read_csv(r".\Notas.csv")
#df = pd.read_csv(r".\_grupos4_2_v2.csv")
...
def tree(df, precondition, dataStructure, node=None, mainRoot=None, latestPath = ""):
    print("PRIORITY 1 MY ACTUAL PRECONDITION: ",precondition)
    currentNode = None
    #print(df)
    ...
    for i in range(0, len(attributes_decision)):
        ...
        print("IMPORTANT Length of the data with condition: ",len(subdata.iloc[:,-1].value_counts().tolist()))
